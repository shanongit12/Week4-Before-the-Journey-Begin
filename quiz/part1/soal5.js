...
Bila masih lebih dari satu digit, terus lakukan perkalian setiap digit-nya untuk pada akhirnya mendapatkan 
satu digit. Wajib menggunakan rekursif untuk berlatih rekursif, namun kamu boleh menggunakan looping
juga disini.
...
function kaliTerusRekursif(angka) {
    ...
    if(String(angka).length == 1) {
        ...
        return kaliTerusRekursif(parseInt(String(angka)[0]) * kaliTerusRekursif(parseInt(String(angka).slice(1))))
    }
  }
